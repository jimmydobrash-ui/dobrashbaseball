        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            ...
            <div className="flex items-center gap-5">
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@jimmydobrash"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="text-mist hover:text-diamond transition-colors duration-200"
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/dobrash_diamond_development"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/profile.php?id=61559608598884"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-mist hover:text-diamond transition-colors duration-200"
